...
class TradingSettings:
    ...
    ltf_timeframe: str = "3m"               # Lower Time Frame (진입/청산)
    ...
    market_structure_lookback: int = 30             # 시장 구조 분석 기간
    market_sideways_atr_threshold: float = 1.0      # ATR의 1배 이하 = 타이트한 횡보
    
    # =================== 횡보 전략용 (횡보장 진입 신호) ===================
    enable_sideways_strategy: bool = True           # 횡보 전략 활성화
    sideways_entry_atr_multiplier: float = 1.5     # 횡보 진입용: ATR의 1.5배 이내
    sideways_entry_lookback: int = 20               # 횡보 진입 판단 기간
    sideways_entry_min_oscillations: int = 2        # 최소 진동 횟수
